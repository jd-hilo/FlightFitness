...
/** Backfill granular set rows from legacy aggregate fields. */
export function ensureExerciseSetRows(exercise: Exercise): Exercise {
...
/** Keep legacy aggregate fields aligned with setRows for AI/coach compatibility. */
export function syncExerciseAggregateFromSetRows(exercise: Exercise): Exercise {
