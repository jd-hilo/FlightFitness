  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 px-4 py-12">
      <div className="max-w-lg mx-auto space-y-6">
        <h1 className="text-2xl font-bold text-amber-400">Configure coaches portal</h1>
        <p className="text-sm text-zinc-400">
          Create{" "}
          <code className="text-amber-300/90 bg-zinc-900 px-1.5 py-0.5 rounded">coaches/.env.local</code>{" "}
          from{" "}
        ...
        <ul className="text-sm space-y-3 border border-zinc-800 rounded-lg p-4 bg-zinc-900/50">
          ...
          <li className="flex gap-2 items-start">
            ...
            <span>
              <code className="text-amber-300/90">COACH_ALLOWED_USER_IDS</code> — Jude&apos;s Supabase user UUID
              (auto-provisions a coach row on first login).
            </span>
          </li>
        </ul>

        <p className="text-xs text-zinc-500">
          This page appears when public Supabase env vars are missing. After saving{" "}
          <code className="text-zinc-400">.env.local</code>, restart the dev server.
        </p>
