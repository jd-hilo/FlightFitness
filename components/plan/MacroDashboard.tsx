...
const styles = StyleSheet.create({
  ...
  tileRow: { flexDirection: 'row', alignItems: 'baseline', gap: 2, marginBottom: 16, flexWrap: 'wrap' },
  tileNum: {
    fontFamily: theme.fonts.headline,
    fontSize: 26,
    color: theme.colors.onBackground,
  ...
  tileRowCompact: { marginBottom: 6, gap: 1 },
  tileNumCompact: { fontSize: 15 },
  tileSlashCompact: { fontSize: 8 },
